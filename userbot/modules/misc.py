...
async def creator(e):
    await e.edit("[Satwik](https://t.me/grandpaa_please)")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Paperplane Extended's README.md file](https://github.com/Devp73/Userbot1/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Click [here](https://github.com/shreyansh8184/UB) to get the lit repo link."
    )
